parameters = [
  { name = " prod.frontend.catalogue_url ", value = "http://catalogue-prod.vemdevops.online:80/" },
  { name = " prod.frontend.cart_url " , value = "http://cart-prod.vemdevops.online:80/" },
  { name = " prod.frontend.user_url " , value = "http://user-prod.vemdevops.online:80/" },
  { name = " prod.frontend.shipping_url " , value = "http://shipping-prod.vemdevops.online:80/" },
  { name = " prod.frontend.payment_url " , value = "http://payment-prod.vemdevops.online:80/" },
  { name = " prod.catalogue.mongo_endpoint " , value = "mongodb-prod.vemdevops.online" },
  ...
  { name = " prod.user.mongodb_endpoint " , value = "mongodb-prod.vemdevops.online" },
  { name = " prod.cart.redis_host " , value = "elasticache-prod-elasticache.fvndue.ng.0001.use1.cache.amazonaws.com" },
  { name = " prod.cart.catalogue_host " , value = "catalogue-prod.vemdevops.online" },
  { name = " prod.cart.catalogue_port " , value = "80" },
  { name = " prod.shipping.cart_endpoint " , value = "cart-prod.vemdevops.online:80" },
  { name = " prod.rds.db_host " , value = "rds-prod-rds.cluster-csieoeticpo1.us-east-1.rds.amazonaws.com" },
  { name = " prod.payment.cart_host " , value = "cart-prod.vemdevops.online" },
  { name = " prod.payment.cart_port " , value = "80" },
  { name = " prod.payment.user_host " , value = "user-prod.vemdevops.online" },
  { name = " prod.payment.user_port " , value = "80" },
  { name = " prod.payment.amqp_host " , value = "rabbitmq-prod.vemdevops.online" },
  { name = " prod.payment.amqp_user " , value = "roboshop" },
  { name = " prod.dispatch.amqp_host " , value = "rabbitmq-prod.vemdevops.online" },
